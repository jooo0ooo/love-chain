    ...
    return (
        ...
        <Container >
            ...
            <ContactUs>
                ...
                <form>
                    <TableOfContactUs>
                        <tr>
                            <td>
                                <input name="input_1" type="text" value={firName} onChange={onChangeFirName} placeholder="First Name*" aria-required="true" aria-invalid="false"/>
                            </td>
                            <td>
                                <input name="input_2" type="text" value={lastName} onChange={onChangeLastName} placeholder="Last Name*" aria-required="true" aria-invalid="false"/>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <input name="input_3" type="text" value={email} onChange={onChangeEmail} placeholder="Email*" aria-required="true" aria-invalid="false"/>
                            </td>
                            <td>
                                <input name="input_4" type="text" value={phone} onChange={onChangePhoneNum} placeholder="Phone Number*" aria-required="true" aria-invalid="false"/>
                            </td>
                        </tr>
                        <tr>
                            <td colSpan={2}>
                                <input name="input_5" type="text" value={company} onChange={onChangeCompany} placeholder="Company*" aria-required="true" aria-invalid="false"/>
                            </td>
                        </tr>
                        <tr>
                            <td colSpan={2}>
                                <textarea name="input_6" placeholder="Message*" aria-required="true" value={message} aria-invalid="false" rows={10} cols={50} onChange={onChangeMessage}/>
                            </td>
                        </tr>
                    </TableOfContactUs>
                </form>
            ...
            <FifthContentBody>
                ...
                <div>“Love, don't fight. But fight for what you love.”<br/><br/><br/>― Richie Norton
                </div>
            </FifthContentBody>
            <SixthContentBody>
